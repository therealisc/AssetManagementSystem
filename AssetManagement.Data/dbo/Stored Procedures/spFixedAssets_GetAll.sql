...
BEGIN
	...
	DurataFunctionareMinima AS MinimumLifetime, DurataFunctionareMaxima AS MaximumLifetime, DenumireClient AS ClientName, Clienti.IdClient AS ClientId,
	DescriereMijlocFix AS FixedAssetDescription, ContContabil AS AccountId, CAST(ValoareIntrare AS decimal(12,2)) AS AssetValue, DurataAmortizareContabila AS MonthsOfAccountingDepreciation,
